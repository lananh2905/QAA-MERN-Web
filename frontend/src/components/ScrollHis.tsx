...
const ScrollHis = ( {onClickSelectChats, refresh}  : {onClickSelectChats: (data: any) => void, refresh: number}) => {
...
//             onClickSelectChats(res.chats);
//         } catch (err) {
//             toast.error("Không thể lấy cuộc trò chuyện này!");
//         }
//     };

//     // Handle click new chat
...
//         <Box sx={{
//             display: "flex",
//             flexDirection: "column", // Sửa lại đúng
//             height: "85vh",
//             width: 0.22,
//             borderRadius: 5,
//         }}>
